...
function PrevencionItem() {
  ...
  return (
    ...
    <br />
                  ...
                  <a href="#tarjeta-prevencion" className='modal-cerrar' onClick={toggleModal}><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="black" class="bi bi-x" viewBox="0 0 16 16">
